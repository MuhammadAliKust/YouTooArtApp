          ...
          child: Column(
            ...
            children: [
              ...
              StreamProvider.value(
                value: _connectionServices.streamFriendRequestUsers(
                    user.getUserDetails()!.docID.toString()),
                initialData: [FriendRequestModel()],
                builder: (context, child) {
                  List<FriendRequestModel> frndRequestList =
                      context.watch<List<FriendRequestModel>>();

                  List<String> sendRequestList =
                      frndRequestList.map((e) => e.otherId.toString()).toList();

                  print(sendRequestList);
                                                                    ...
                                                                    children: [
                                                                      ...list[i]
                                                                        ...
                                                                        return StreamProvider
                                                                            .value(
                                                                          value:
                                                                              _categoryServices.streamCategoryByID(e),
                                                                          initialData:
                                                                              CategoryModel(),
                                                                          builder:
                                                                              (context, child) {
                                                                            return Booster.dynamicFontSize(
                                                                                label: " #" + context.watch<CategoryModel>().categoryName.toString(),
                                                                                fontSize: 12,
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Expanded(
                                                                        child: AppButtonIcon(
                                                                            onTap: () {
                                                                              if (!sendRequestList.contains(list[i].docID.toString()))
                                                                                _connectionServices.sendFriendRequest(otherID: list[i].docID.toString(), myID: user.getUserDetails()!.docID.toString()).then((value) {
                                                                                  getFlushBar(context, title: 'Connection request has been sent successfully');
                                                                                });
                                                                            },
                                                                            Icons: Icons.add,
                                                                            backgroundcolor: Colors.white,
                                                                            shadowcolor: Color(0xffF1F1F1),
                                                                            textcolor: sendRequestList.contains(list[i].docID.toString()) ? Colors.grey : Colors.black),
                                                                      ),
                                                                      Booster
                                                                          .horizontalSpace(
                                                                              15),
                                                                      Expanded(
                                                                        child: AppButtonIcon(
                                                                            onTap: () {
                                                                              Get.to(() => MessagesView(receiverID: list[i].docID.toString(), myID: user.getUserDetails()!.docID.toString()));
                                                                            },
                                                                            Icons: Icons.mail,
                                                                            backgroundcolor: Colors.white,
                                                                            shadowcolor: Color(0xffF1F1F1),
                                                              ...
                                                              Stack(
                                                                ...
                                                                children: [
                                                                  CircleAvatar(
                                                                    radius: 40,
                                                                    backgroundImage:
                                                                        NetworkImage(searchedConnections[i]
                                                                            .image
                                                                            .toString()),
                                                                  ),
                                                                  Positioned.fill(
